			...
			<form action="" id="manage-trainer">
				<div class="card">
					...
					<div class="card-body">
							...
							<div class="form-group">
								<label class="control-label">Expected trainer</label>
							...
							<div class="form-group">
								<label class="control-label">Fees Paid</label>
...
<script>
	...
	$('.delete_trainer').click(function(){
		_conf("Are you sure to delete this member ?","delete_trainer",[$(this).attr('data-id')])
	})
